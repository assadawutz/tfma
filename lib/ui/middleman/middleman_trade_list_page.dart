...
class _MiddlemanTradeListPageState extends State<MiddlemanTradeListPage> {
    ...
    return Column(
      ...
      children: [
        MiddlemanSearchField(
          ...
          hintText: 'ค้นหาเลขอ้างอิง คู่ค้า หรือหมู่บ้าน',
  ...
  List<TradeRecord> _filterTrades() {
    final base = _repository.tradeRecords
    ...
    return base
        .where((trade) =>
            '${trade.referenceId} ${trade.counterparty}'.toLowerCase().contains(query))
        .toList();
  }
